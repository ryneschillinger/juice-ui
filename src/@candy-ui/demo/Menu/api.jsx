...
&lt;<span class="val">Menu</span> <span class="attr">type</span>="<span class="val">${type}</span>" <span class="attr">view</span>="<span class="val">${view}</span>" <span class="attr">color</span>="<span class="val">${color}</span>"&gt;
  &lt;<span class="val">MenuItem</span>
  ...
  /&gt;
  &lt;<span class="val">MenuDivider</span> <span class="attr">type</span>="<span class="val">${type}</span>" <span class="attr">view</span>="<span class="val">${view}</span>" <span class="attr">color</span>="<span class="val">${color}</span>"&gt;
  &lt;<span class="val">MenuItem</span>
    <span class="attr">type</span>="<span class="val">${type}</span>"
    <span class="attr">view</span>="<span class="val">${view}</span>"
    <span class="attr">color</span>="<span class="val">${color}</span>"
  ...
  &lt;<span class="val">MenuItem</span>
    ...
    <span class="attr">labelElement</span>={&lt;<span class="val">Icon</span> <span class="attr">icon</span>="<span class="val">new-link</span>" /&gt;}
  /&gt;
  &lt;<span class="val">MenuDivider</span> <span class="attr">type</span>="<span class="val">${type}</span>" <span class="attr">view</span>="<span class="val">${view}</span>" <span class="attr">color</span>="<span class="val">${color}</span>"&gt;
  &lt;<span class="val">MenuItem</span>
    <span class="attr">type</span>="<span class="val">${type}</span>"
    ...
    <span class="attr">labelElement</span>={&lt;<span class="val">Icon</span> <span class="attr">icon</span>="<span class="val">share</span>" /&gt;}
  /&gt;
&lt;/<span class="val">Menu</span>&gt;

<span class="cmnt">/*** DEMO #2 ***/</span>
&lt;<span class="val">Menu</span> <span class="attr">type</span>="<span class="val">${type}</span>" <span class="attr">view</span>="<span class="val">${view}</span>" <span class="attr">color</span>="<span class="val">${color}</span>"&gt;
  &lt;<span class="val">MenuDivider</span> <span class="attr">title</span>="<span class="val">Edit</span>" <span class="attr">type</span>="<span class="val">${type}</span>" <span class="attr">view</span>="<span class="val">${view}</span>" <span class="attr">color</span>="<span class="val">${color}</span>"&gt;
  &lt;<span class="val">MenuItem</span>
    <span class="attr">type</span>="<span class="val">${type}</span>"
    <span class="attr">view</span>="<span class="val">${view}</span>"
    <span class="attr">color</span>="<span class="val">${color}</span>"
  ...
  /&gt;
  &lt;<span class="val">MenuDivider</span> <span class="attr">title</span>="<span class="val">Text</span>" <span class="attr">type</span>="<span class="val">${type}</span>" <span class="attr">view</span>="<span class="val">${view}</span>" <span class="attr">color</span>="<span class="val">${color}</span>"&gt;
  &lt;<span class="val">MenuItem</span>
    <span class="attr">type</span>="<span class="val">${type}</span>"
    <span class="attr">view</span>="<span class="val">${view}</span>"
    <span class="attr">color</span>="<span class="val">${color}</span>"
  ...
  &gt;
    ...
    &gt;
      ...
      &lt;<span class="val">MenuItem</span>
        ...
        <span class="attr">onClick</span>={<span class="js">() => copyToClipboard("COUPONCODE")</span>}
      /&gt;
    &lt;/<span class="val">MenuItem</span>&gt;
  &lt;/<span class="val">MenuItem</span>&gt;
&lt;/<span class="val">Menu</span>&gt;
