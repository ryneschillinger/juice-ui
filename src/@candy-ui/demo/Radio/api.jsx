...
&lt;<span class="val">RadioGroup</span> <span class="attr">label</span>="<span class="val">Select platform:</span>" <span class="attr">name</span>="<span class="val">Demo group</span>"&gt;
  &lt;<span class="val">Radio</span>
    ...
    <span class="attr">style</span>={<span class="js">{ margin: "0.5rem" }</span>}
    <span class="attr">checked</span>={<span class="bool">${os === "win" ? "true" : "false"}</span>}
    <span class="attr">onClick</span>={<span class="js">() => setOS("win")</span>}
  ...
  &lt;<span class="val">Radio</span>
    ...
    <span class="attr">style</span>={<span class="js">{ margin: "0.5rem" }</span>}
    <span class="attr">checked</span>={<span class="bool">${os === "lin" ? "true" : "false"}</span>}
    <span class="attr">onClick</span>={<span class="js">() => setOS("lin")</span>}
  ...
  &lt;<span class="val">Radio</span>
    ...
    <span class="attr">style</span>={<span class="js">{ margin: "0.5rem" }</span>}
    <span class="attr">checked</span>={<span class="bool">${os === "and" ? "true" : "false"}</span>}
    <span class="attr">onClick</span>={<span class="js">() => setOS("and")</span>}
    ...
    ${dis ? `<span class="attr">disabled</span>={<span class="js">disableCondition</span>}` : ''}
  /&gt;
&lt;/<span class="val">RadioGroup</span>&gt;
`;
