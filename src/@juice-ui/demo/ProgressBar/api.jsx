...
export const API = props => {
  ...
  /** Code source */
  const Code = `  
&lt;<span class="el">ProgressBar</span>&gt;
  <span class="attr">color</span>="<span class="val">${color}</span>"
  <span class="attr">value</span>={<span class="num">${value / 100}</span>}
  ${stripes ? `<span class="attr">stripes</span>` : ''}
  ${animate ? `<span class="attr">animate</span>` : ''}
/&gt;
`;
