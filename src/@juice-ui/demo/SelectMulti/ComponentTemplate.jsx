...
const Props = {
  name: "MultiSelect",
  desc: "Use MultiSelect for choosing multiple items in a list.",
  /**default value*/
  type: "def",
  view: "outlined",
  color: "primary"
...
const Content = props => {
  ...
  React.useEffect(() => {
    ...
    document.getElementsByTagName("META")[
      "description"
    ].content = `Demo ${Props.name} component for React JuiceUI Design System with possible props. ${Props.desc}`;
  });
