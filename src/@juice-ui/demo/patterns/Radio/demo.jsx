  ...
  return (
    <div className={DemoAppStyle["content-container"]}>
      <div className={DemoAppStyle["content-component"]}>
        ...
        <div id="rightControl">
          <Link exact to="/patterns/radio#right-control">
            <Typo type="h5" color="primary" colorStep={80} className={styles.sub_title}>
              Is this the right control to use?
            </Typo>
          </Link>
        ...
        {/* Guidelines */}
        <div id="guidelines">
          <Link exact to="/patterns/radio#guidelines">
            <Typo type="h5" color="primary" colorStep={80} className={styles.sub_title}>
              Guidelines
            </Typo>
          </Link>
          {/* General */}
          <Typo type="h6" className={styles.sub_title}>
            General
          </Typo>
          <Typo className={styles.text}>
            <ul>
        ...
        {/* Labels */}
        <div id="labels">
          <Link exact to="/patterns/radio#labels">
            <Typo type="h5" color="primary" colorStep={80} className={styles.sub_title}>
              Labels
            </Typo>
          </Link>
        ...
        <div id="documentation">
          <Link exact to="/patterns/radio#documentation">
            <Typo type="h5" color="primary" colorStep={80} className={styles.sub_title}>
              Documentation
            </Typo>
          </Link>
      ...
      <SidebarContainer>
        ...
        >
          ...
          >
            <Label className={DemoAppStyle["sidebar_toc_label"]}>
