...
let DatePicker = DatePicker_1 = class DatePicker extends AbstractPureComponent2 {
    ...
    maybeRenderTimePicker() {
        ...
        return (React.createElement("div", { className: Classes.DATEPICKER_TIMEPICKER_WRAPPER },
            React.createElement(TimePicker, Object.assign({ precision: timePrecision, minTime: applyMin ? minDate : undefined, maxTime: applyMax ? maxDate : undefined }, timePickerProps, { onChange: this.handleTimeChange, value: this.state.value }))));
    }
