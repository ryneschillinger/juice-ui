...
let DateRangePicker = DateRangePicker_1 = class DateRangePicker extends AbstractPureComponent2 {
    ...
    renderCalendars(isShowingOneMonth) {
        ...
        if (isShowingOneMonth) {
            return (React.createElement(DayPicker, Object.assign({}, dayPickerBaseProps, { captionElement: this.renderSingleCaption, navbarElement: this.renderSingleNavbar, fromMonth: minDate, month: this.state.leftView.getFullDate(), numberOfMonths: 1, onMonthChange: this.handleLeftMonthChange, toMonth: maxDate, renderDay: dayPickerProps?.renderDay ?? this.renderDay })));
        }
        else {
            return [
