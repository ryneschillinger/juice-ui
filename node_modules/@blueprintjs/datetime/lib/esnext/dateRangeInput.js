...
let DateRangeInput = DateRangeInput_1 = class DateRangeInput extends AbstractPureComponent2 {
    constructor(props, context) {
        ...
        this.refHandlers = {
            endInputRef: isRefObject(this.props.endInputProps.inputRef)
                ? (this.endInputRef = this.props.endInputProps.inputRef)
                : (ref) => {
                    this.endInputRef = ref;
                    this.props.endInputProps.inputRef?.(ref);
                },
            startInputRef: isRefObject(this.props.startInputProps.inputRef)
                ? (this.startInputRef = this.props.startInputProps.inputRef)
                : (ref) => {
                    this.startInputRef = ref;
                    this.props.startInputProps.inputRef?.(ref);
                },
        };
    ...
    render() {
        ...
        const popoverContent = (React.createElement(DateRangePicker, Object.assign({}, this.props, { selectedShortcutIndex: selectedShortcutIndex, boundaryToModify: this.state.boundaryToModify, onChange: this.handleDateRangePickerChange, onShortcutChange: this.handleShortcutChange, onHoverChange: this.handleDateRangePickerHoverChange, value: this.getSelectedRange() })));
