...
var DateInput = /** @class */ (function (_super) {
    ...
    function DateInput() {
        ...
        _this.handleInputKeyDown = function (e) {
            ...
            if (e.which === core_1.Keys.ENTER) {
                ...
                _this.setState({ isOpen: false });
                core_1.getRef(_this.inputEl).blur();
            }
    ...
    DateInput.prototype.render = function () {
        ...
        var dayPickerProps = tslib_1.__assign(tslib_1.__assign({}, this.props.dayPickerProps), { 
            ...
            onDayKeyDown: function (day, modifiers, e) {
                ...
                if (e.key === "Tab" &&
                    !e.shiftKey &&
                    _this.lastTabbableElement.classList.contains(Classes.DATEPICKER_DAY)) {
                    _this.setState({ isOpen: false });
                }
        ...
        return (React.createElement(core_1.Popover, tslib_1.__assign({ isOpen: this.state.isOpen && !this.props.disabled, fill: this.props.fill }, popoverProps, { autoFocus: false, className: classnames_1.default(popoverProps.className, this.props.className), content: wrappedPopoverContent, enforceFocus: false, onClose: this.handleClosePopover, popoverClassName: classnames_1.default(Classes.DATEINPUT_POPOVER, popoverProps.popoverClassName) }),
            React.createElement(core_1.InputGroup, tslib_1.__assign({ autoComplete: "off", intent: isErrorState ? core_1.Intent.DANGER : core_1.Intent.NONE, placeholder: this.props.placeholder, rightElement: this.props.rightElement, type: "text" }, inputProps, { disabled: this.props.disabled, inputRef: this.refHandlers.input, onBlur: this.handleInputBlur, onChange: this.handleInputChange, onClick: this.handleInputClick, onFocus: this.handleInputFocus, onKeyDown: this.handleInputKeyDown, value: dateString }))));
    };
