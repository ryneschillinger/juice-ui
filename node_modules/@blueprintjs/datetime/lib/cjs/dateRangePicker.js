...
var DateRangePicker = /** @class */ (function (_super) {
    ...
    function DateRangePicker(props, context) {
        ...
        _this.getDateRangePickerModifiers = function () {
            ...
            return datePickerCore_1.combineModifiers(_this.modifiers, tslib_1.__assign({ isToday: _this.shouldHighlightCurrentDay }, modifiers));
        };
        ...
        _this.getDisabledDaysModifier = function () {
            ...
            return disabledDays instanceof Array ? tslib_1.__spreadArrays([_this.disabledDays], disabledDays) : [_this.disabledDays, disabledDays];
        };
    ...
    DateRangePicker.prototype.renderCalendars = function (isShowingOneMonth) {
        ...
        var dayPickerBaseProps = tslib_1.__assign(tslib_1.__assign({ locale: locale,
