...
var DateRangeInput = /** @class */ (function (_super) {
    ...
    function DateRangeInput(props, context) {
        ...
        _this.refHandlers = {
            endInputRef: core_1.isRefObject(_this.props.endInputProps.inputRef)
                ? (_this.endInputRef = _this.props.endInputProps.inputRef)
                : function (ref) {
                    var _a;
                    _this.endInputRef = ref;
                    (_a = _this.props.endInputProps.inputRef) === null || _a === void 0 ? void 0 : _a(ref);
                },
            startInputRef: core_1.isRefObject(_this.props.startInputProps.inputRef)
                ? (_this.startInputRef = _this.props.startInputProps.inputRef)
                : function (ref) {
                    var _a;
        ...
        _this.handleInputBlur = function (_e, boundary) {
            ...
            if (_this.isInputEmpty(values.inputString)) {
                if (isValueControlled) {
                    nextState = tslib_1.__assign(tslib_1.__assign({}, nextState), (_b = {}, _b[keys.inputString] = dateFormat_1.getFormattedDateString(values.controlledValue, _this.props), _b));
                }
                else {
    ...
    DateRangeInput.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        var startInputRef = core_1.getRef(this.startInputRef);
        var endInputRef = core_1.getRef(this.endInputRef);
