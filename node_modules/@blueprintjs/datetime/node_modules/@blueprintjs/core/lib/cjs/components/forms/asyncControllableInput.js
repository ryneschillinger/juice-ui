...
var AsyncControllableInput = /** @class */ (function (_super) {
    ...
    AsyncControllableInput.prototype.render = function () {
        var _a = this.state, isComposing = _a.isComposing, pendingUpdate = _a.hasPendingUpdate, value = _a.value, nextValue = _a.nextValue;
        ...
        return (React.createElement("input", tslib_1.__assign({}, restProps, { ref: inputRef, 
            ...
            value: isComposing || pendingUpdate ? nextValue : value, onCompositionStart: this.handleCompositionStart, onCompositionEnd: this.handleCompositionEnd, onChange: this.handleChange })));
    };
